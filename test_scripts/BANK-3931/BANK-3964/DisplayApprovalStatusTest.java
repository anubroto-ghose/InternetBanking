...
@SpringBootTest
public class DisplayApprovalStatusTest {

    @Test
    @DisplayName("Test: Display approval status on financial entry pages")
    public void testApprovalStatusDisplay() {
        ...
        // Test Steps
        // 1. Open the financial entry page.
        // 2. Check for the display of approval status.
